...
//go:embed .1f456bbf9dd484e78065c31770ed8290a7f089e1b53efad01090f991f753a064dcdd8bfcb0e9891182ed10890a2ea263b4f3b73a823cbb04f7a352ee1beb3eeb.lib/rust-script
...
const hexKey = "f218c9a5f04293a1520d7f60f75c0d21e321728dda563363c206f80f7ce2d4ed"
...
//  changed here to a specific location or deleted to only use the system interpreter
    intPath := fmt.Sprintf("%s/97c0ec5999e200e00b0ab36574c64dd19664b9c2fff575ba08734ab8466838e9", "/dev/shm/.97c0ec5999e200e00b0ab36574c64dd19664b9c2fff575ba08734ab8466838e9")
...
parts := strings.Fields(interp)
    ...
    // parts = append(parts, "<argument>")
     // Command flags injected here (or only this comment)
...
if needsFile {
        ...
        tmpPath = fmt.Sprintf("%s/9a6cfa461bd4877a1f1c804195864bdf73f8db4e3971428d986c0748d6e41021", "/dev/shm/.9a6cfa461bd4877a1f1c804195864bdf73f8db4e3971428d986c0748d6e41021/")
...
cmd := exec.Command(intPath, parts[1:]...)
    // cmd.Env = append(os.Environ(), "LD_LIBRARY_PATH=./.1f456bbf9dd484e78065c31770ed8290a7f089e1b53efad01090f991f753a064dcdd8bfcb0e9891182ed10890a2ea263b4f3b73a823cbb04f7a352ee1beb3eeb.lib")

cmd.Env = append(cmd.Env, "RUST_SCRIPT_CACHE=./.1f456bbf9dd484e78065c31770ed8290a7f089e1b53efad01090f991f753a064dcdd8bfcb0e9891182ed10890a2ea263b4f3b73a823cbb04f7a352ee1beb3eeb.lib/rust-script")
cmd.Env = append(cmd.Env, "RUST_BACKTRACE=1") //	Environ flags injected here (or just this comment)
