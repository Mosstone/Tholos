...
//go:embed .5987d22f5645a2e322f50a074e36d56f02f00b9086d248e11cf3a4187859be6a97011e380aa2a888ebd3c4ef18af0e24dcdd53f6109f98c3a61508ef25e4586e.lib/hugs
var interpreter []byte

//go:embed hugs.test.run.hs
var script []byte
...
const hexKey = "adfd6151644b1bc5e2b589b5bc8e964d5b0d5e683af585296eafbd7774dad2ea"
...
//  changed here to a specific location or deleted to only use the system interpreter
    intPath := fmt.Sprintf("%s/bb42942b8f4bf6f78cab1f06b596d4f678b285e4f7aa4d848a43804d6beb1c11", "/dev/shm/.bb42942b8f4bf6f78cab1f06b596d4f678b285e4f7aa4d848a43804d6beb1c11")
...
parts = append(parts, ":") // Interpreter flags injected here (or it's just this comment)
...
if needsFile {
        ...
        tmpPath = fmt.Sprintf("%s/d701de669b385420272aedebaac9602fef8a7830410be4a928268715786cbe03", "/dev/shm/.d701de669b385420272aedebaac9602fef8a7830410be4a928268715786cbe03/")
...
cmd := exec.Command(intPath, parts[1:]...)
    cmd.Env = append(os.Environ(), "LD_LIBRARY_PATH=./.5987d22f5645a2e322f50a074e36d56f02f00b9086d248e11cf3a4187859be6a97011e380aa2a888ebd3c4ef18af0e24dcdd53f6109f98c3a61508ef25e4586e.lib")
