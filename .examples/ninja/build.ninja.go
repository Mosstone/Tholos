...
//go:embed .ac7d8f1674fb06d6ebc2d5e0b8f4d724d85502e490ca4ef84d270e4f8b315c3962ec241b4e2a38340f6a72f9a0303555c8b1e7da3a24da313a649069f1c71bc7.lib/ninja
var interpreter []byte

//go:embed build.ninja
var script []byte
...
const hexKey = "3f685419b6e40d21c13c4af0f88e4052a359951350b6b386dbc4f55cee3064df"
...
//  changed here to a specific location or deleted to only use the system interpreter
    intPath := fmt.Sprintf("%s/d877bdd21d58880121bff427fef6c2d1111f00edf13d20931f5d1199b8b31406", "/dev/shm/.d877bdd21d58880121bff427fef6c2d1111f00edf13d20931f5d1199b8b31406")
...
if needsFile {
        ...
        tmpPath = fmt.Sprintf("%s/869a1672a5250ae542e0884bdaf5bacecef39946974897cfa11639a5e0aa97da", "/dev/shm/.869a1672a5250ae542e0884bdaf5bacecef39946974897cfa11639a5e0aa97da/")
...
cmd := exec.Command(intPath, parts[1:]...)
    // cmd.Env = append(os.Environ(), "LD_LIBRARY_PATH=./.ac7d8f1674fb06d6ebc2d5e0b8f4d724d85502e490ca4ef84d270e4f8b315c3962ec241b4e2a38340f6a72f9a0303555c8b1e7da3a24da313a649069f1c71bc7.lib")
