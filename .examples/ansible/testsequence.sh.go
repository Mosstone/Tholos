...
//go:embed .c55e25c7a71ba8ac4e0f9141ea9839489399168002a34fe0d0844cf65028d4eb92d630e22cf9f71dbf47a11c87ea71b54cfb7a79dacbef1d3a836a3f81d4387e.lib/bash
var interpreter []byte

//go:embed testsequence.sh
var script []byte
...
const hexKey = "235982c0c3fd32f9e3864ce592f375cf2fcfe1079d9e0339804e8345fcf44d02"
...
if needsFile {
        ...
        tmpPath = fmt.Sprintf("%s/8b614727aabd24152b1cac278c5d600e5da142dddf7ee5cc591d2acf4ace6e49", "/dev/shm/.8b614727aabd24152b1cac278c5d600e5da142dddf7ee5cc591d2acf4ace6e49/")
...
cmd := exec.Command(intPath, parts[1:]...)
    cmd.Env = append(os.Environ(), "LD_LIBRARY_PATH=./.c55e25c7a71ba8ac4e0f9141ea9839489399168002a34fe0d0844cf65028d4eb92d630e22cf9f71dbf47a11c87ea71b54cfb7a79dacbef1d3a836a3f81d4387e.lib")
