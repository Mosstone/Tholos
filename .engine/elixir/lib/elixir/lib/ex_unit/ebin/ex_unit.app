{application,ex_unit,
             [{modules,['Elixir.ExUnit','Elixir.ExUnit.AssertionError',
                        ...
                        'Elixir.ExUnit.OnExitHandler.Supervisor',
                        'Elixir.ExUnit.Runner','Elixir.ExUnit.RunnerStats',
                        'Elixir.ExUnit.Server','Elixir.ExUnit.Test',
                        'Elixir.ExUnit.TestCase','Elixir.ExUnit.TestModule',
